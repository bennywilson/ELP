	...
	bool bUsesShadingModelFromMaterialExpression)
{
	...
	case MP_SubsurfaceColor:
		...
		break;
	case MP_CustomData0:
		Active = ShadingModels.HasAnyShadingModel({ MSM_ClearCoat, MSM_Hair, MSM_Cloth, MSM_Eye, MSM_StylizedHuman });	// ELP bwilson
		break;
	case MP_CustomData1:
		Active = ShadingModels.HasAnyShadingModel({ MSM_ClearCoat, MSM_Eye, MSM_StylizedHuman });	// ELP bwilson
		break;
